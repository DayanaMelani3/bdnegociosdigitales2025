...
db.fabricantes.insertOne({
  ...
  "Nombre": "FabriTools",
  "Productos": [
    { "Producto": "Martillo", "Precio": 20 },
    { "Producto": "Tornillo", "Precio": 2 }
  ]
})


mongoimport --db curso --collection empleados --file empleados.json --jsonArray
...
db.empleados.find({ "ventas": { "$lt": 10000 } }).limit(1)
